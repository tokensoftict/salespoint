                ...
                <section class="panel">
                    <header class="panel-heading">
                        ...
                        <span class="pull-right">
                             @if(userCanView('invoiceandsales.edit'))
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    ...
                                    @if($invoice->status == "DRAFT" && userCanView('invoiceandsales.complete_invoice_no_edit'))
                                        <form action="{{ route('invoiceandsales.complete_invoice_no_edit',$invoice->id) }}" method="post">
                                            {{ csrf_field() }}
                                        <br/>
                                        <hr/>
                                        <br/>

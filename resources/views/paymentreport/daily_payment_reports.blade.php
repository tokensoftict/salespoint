                    ...
                    <header class="panel-heading">
                        ...
                        <form action=""  class="tools pull-right" style="margin-right: 80px" method="post">
                            ...
                            <div class="row">
                                <div class="col-sm-8">
                                    <label>Date</label>
                                    <input type="text" class="form-control datepicker js-datepicker" data-min-view="2" data-date-format="yyyy-mm-dd" style="background-color: #FFF; color: #000;"  value="{{ $date }}" name="date" placeholder="From"/>
                                </div>

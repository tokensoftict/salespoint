                            ...
                            <div class="form-group">
                                ...
                                <select required id="deduction_id" name="deduction_id" class="form-control">
                                    <?php $__currentLoopData = $deductions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deduction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($deduction->id); ?>"><?php echo e($deduction->name); ?></option>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/salespoint/resources/views/payroll/periods/extra_deduction.blade.php ENDPATH**/ ?>
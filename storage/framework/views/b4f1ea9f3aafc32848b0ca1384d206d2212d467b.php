                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <select class="form-control" name="bank">
                                        <?php $__currentLoopData = $banks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $_bank): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option <?php echo e($bank == $_bank->id ? "selected" : ""); ?> value="<?php echo e($_bank->id); ?>"><?php echo e($_bank->account_number); ?> - <?php echo e($_bank->bank->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/salespoint/resources/views/paymentreport/monthly_payment_report_by_method_by_bank.blade.php ENDPATH**/ ?>
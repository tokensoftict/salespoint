        ...
        <div class="row">
            <div class="col-md-3 col-sm-6">
                <div class="panel short-states">
                    ...
                    <div class="panel-body">
                        <h1><?php echo e(number_format(dailySales(),2)); ?></h1>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="panel short-states">
                    ...
                    <div class="panel-body">
                        <h1><?php echo e(number_format(weeklySales(),2)); ?></h1>
                        <div class="text-info pull-right"> <i class="fa fa-level-up"></i></div>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="panel short-states">
                    ...
                    <div class="panel-body">
                        <h1><?php echo e(number_format(monthlySales(),2)); ?></h1>
                        <div class="text-info pull-right"> <i class="fa fa-level-up"></i></div>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="panel short-states">
                    ...
                    <div class="panel-body">
                        <h1><?php echo e(\App\Models\Stock::where('status',1)->count()); ?></h1>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/salespoint/resources/views/dashboard.blade.php ENDPATH**/ ?>
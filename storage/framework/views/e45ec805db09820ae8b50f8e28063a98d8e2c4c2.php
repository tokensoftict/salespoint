                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <select class="form-control" name="customer_id">
                                        <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $_customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option <?php echo e($customer == $_customer->id ? "selected" : ""); ?> value="<?php echo e($_customer->id); ?>"><?php echo e($_customer->firstname); ?> <?php echo e($_customer->lastname); ?></option>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if(userCanView('deposits.print_afour')): ?>
                                            <a href="<?php echo e(route('deposits.print_afour',$deposit->id)); ?>" class="btn btn-sm btn-success">Print</a>
                                        <?php endif; ?>
                                        <?php if(userCanView('deposits.edit')): ?>
                                            <a href="<?php echo e(route('deposits.edit',$deposit->id)); ?>" class="btn btn-sm btn-primary">Edit</a>
                                        <?php endif; ?>
                                        <?php if(userCanView('deposits.destroy')): ?>
                                            <a href="<?php echo e(route('deposits.destroy',$deposit->id)); ?>" class="btn btn-sm btn-danger">Delete</a>
                                        <?php endif; ?>
                                    </td>
                                </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/salespoint/resources/views/deposit/monthly_report_by_customer.blade.php ENDPATH**/ ?>
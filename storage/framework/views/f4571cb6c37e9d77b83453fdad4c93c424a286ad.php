                        ...
                        <table class="table table-bordered table-responsive table-striped convert-data-table" style="font-size: 12px">
                            ...
                            <?php $__currentLoopData = $deductions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $deduction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($deduction->employee->employee_no); ?></td>
                                    <td><?php echo e($deduction->employee->name); ?></td>
                                    <td><?php echo e(number_format($deduction->amount ,2)); ?></td>
                                    <td><?php echo e($deduction->tenure > 0 ? number_format($deduction->total_amount,2) : ""); ?></td>
                                    <td><?php echo e($deduction->tenure > 0 ? $deduction->tenure." Month(s)" : "Infinity"); ?> </td>
                                    <td><?php echo e(eng_str_date($deduction->start_date)); ?></td>
                                    <td><?php echo e($deduction->tenure > 0 ? eng_str_date($deduction->end_date) : ""); ?></td>
                                    <td><?php echo $deduction->status == 0 ? label("Pending","default") : ( $deduction->status == 1 ? label("Approved","primary") : label("Completed","success") ); ?></td>
                                    <td><?php echo e($deduction->comment); ?></td>
                                    <td>
                                        <?php if(userCanView('periods.stop_running_deduction') && $deduction->status == 1): ?>
                                            <a href="<?php echo e(route('periods.stop_running_deduction',$deduction->id)); ?>"  class="btn btn-sm btn-primary confirm_action" data-msg="Are you sure, you want stop this deduction">Stop</a>
                                        <?php endif; ?>
                                    </td>
                                </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/salespoint/resources/views/payroll/periods/extra_deduction_list.blade.php ENDPATH**/ ?>